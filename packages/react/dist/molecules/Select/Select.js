...
const Select = ({ options = [], label = 'Please select an option', onOptionSelected, }) => {
    ...
    return (React.createElement("div", { className: "dsf-select", "data-testid": "select-react" },
        React.createElement("button", { "aria-haspopup": true, "aria-expanded": isOpen ? true : undefined, "aria-controls": "dsf-select-list", className: "dsf-select__label", onClick: () => onLabelClick(), ref: labelRef, "data-testid": "dsfSelectButton" },
            React.createElement(Text, null, selectedOption === null ? label : selectedOption.label)),
        isOpen && (React.createElement("ul", { id: "dsf-select-list", role: "menu", style: { top: overlayTop }, className: "dsf-select__overlay", "data-testid": "dsfSelectList" }, options.map((option, index) => {
